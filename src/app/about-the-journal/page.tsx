        ...
        <div className="flex-grow">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="card-terminal flex flex-col">
              <h3 className="heading-display text-xl text-[#F8FAFC] mb-3 border-b border-[#30363D] pb-2">Focus & Scope</h3>
              <p className="text-sm text-[#F8FAFC] opacity-80 leading-relaxed text-justify flex-grow">
            ...
            {/* Card 2: Open Access */}
            <div className="card-terminal flex flex-col">
              <h3 className="heading-display text-xl text-[#F8FAFC] mb-3 border-b border-[#30363D] pb-2">Open Access & Peer Review</h3>
              <p className="text-sm text-[#F8FAFC] opacity-80 leading-relaxed text-justify flex-grow">
            ...
            {/* Card 3: Submissions */}
            <div className="card-terminal flex flex-col">
              <h3 className="heading-display text-xl text-[#F8FAFC] mb-3 border-b border-[#30363D] pb-2">Who Should Submit?</h3>
              <p className="text-sm text-[#F8FAFC] opacity-80 leading-relaxed text-justify flex-grow">
            ...
            {/* Card 4: Vision */}
            <div className="card-terminal flex flex-col">
              <h3 className="heading-display text-xl text-[#F8FAFC] mb-3 border-b border-[#30363D] pb-2">Our Vision</h3>
              <p className="text-sm text-[#F8FAFC] opacity-80 leading-relaxed text-justify flex-grow">
