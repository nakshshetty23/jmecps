    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
      ...
      <div className="flex flex-col lg:flex-row gap-12">
        <div className="flex-grow">
          ...
          <div className="card-terminal relative border-[#38BDF8]">
            ...
            <h2 className="heading-display text-2xl text-[#F8FAFC] mb-6 pl-4 border-l-2 border-[#EAB308]">
              Recent Trends in Mechanical, Electronics and Cyber Physical Systems
            </h2>
            
            <div className="space-y-5 text-[1.05rem] leading-relaxed text-[#F8FAFC] opacity-80 text-justify">
              <p>
            ...
            <div className="mt-10 pt-6 border-t border-[#30363D] flex items-center justify-between font-mono text-sm uppercase tracking-widest">
              <div>
                <h3 className="heading-display text-xl text-[#38BDF8] mb-1">EDITOR-IN-CHIEF</h3>
                <p className="text-[#F8FAFC] opacity-60">
                  JMECPS
                </p>
                <a href="https://www.jmecps.com" target="_blank" rel="noopener noreferrer" className="text-[#EAB308] hover:text-[#F8FAFC] transition-none mt-2 inline-block">
                  [WWW.JMECPS.COM]
                </a>
              </div>
              <div className="hidden sm:flex w-16 h-16 border-2 border-[#EAB308] items-center justify-center text-[#EAB308] heading-display text-2xl">
                JM
              </div>
            </div>
          </div>
