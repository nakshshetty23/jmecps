      ...
      <div className="flex flex-col lg:flex-row gap-12">
        <div className="flex-grow">
          ...
          <div className="card-terminal mb-8 border-accent">
            <h2 className="heading-display text-2xl text-text mb-6 flex items-center gap-3">
              Mission
            </h2>
            <ul className="space-y-4 font-mono text-sm text-text opacity-80">
              {[
                ...
                <li key={index} className="flex items-start gap-4 leading-relaxed text-justify">
                  <span className="flex-shrink-0 flex items-center justify-center w-6 h-6 border border-accent text-accent text-xs mt-0.5">
