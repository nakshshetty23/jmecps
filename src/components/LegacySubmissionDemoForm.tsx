...
// Informational demo on the public /submission page — not the real
// submission workflow (see /submissions/new for that, which is a real
// Server Action against the database). Split out from the page itself so
// the page can stay a Server Component (needed for Sidebar's server-side
// auth check) while this one piece keeps its local form state.
export default function LegacySubmissionDemoForm() {
